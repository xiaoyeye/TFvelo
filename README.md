...
Due to the wide usage of scVelo (Bergen, Volker, et al. "Generalizing RNA velocity to transient cell states through dynamical modeling." Nature biotechnology 38.12 (2020): 1408-1414, [link](https://github.com/theislab/scvelo)) and its clean, well-organized codes, we develop TFvelo based on the framework of scvelo. 
